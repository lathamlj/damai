    ...
    <Craft.Section className="border-b">
      <Craft.Container className="grid md:grid-cols-2 md:gap-12 items-stretch">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="font-light leading-[1.4] opacity-70">
            <p>
              ...
              they decided to test the idea of using a remote offshore worker to support the busy medical practice.
            </p>
            <p>
              ...
              leading to the birth of Damai Global.
            </p>
            <p>
